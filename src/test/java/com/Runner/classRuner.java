...
public class classRuner extends Base_Class {
		...
		for (int i = 1; i <= ehrrow; i++) {
			...
			for (int j = 1; j <= qf.size(); j++) {
				...
				if (tagnames.equals("vital")) {
					...
					List<WebElement> tyr = driver.findElements(
							By.xpath("//div[@id='Test_OrderKpop2']/div[2]/div[1]//following::ul[3]/li/a/div/span"));
					for (WebElement webE : tyr) {
						if (webE.getText().contains("LOINC NUM :5802-4")) {
							webE.click();
							break;
						}
					...
					uk.sendKeys(ConfigManager.getconfigManager().getInstanceConfigReader().doctorKpid());// kpid mention
																											// dr...
					sleep(3000);
					List<WebElement> rwr = driver.findElements(By.xpath(
							"//div[@id='ReferralKpop2']/div[2]/div[2]//following::ul[1]/li/a/table[1]/tbody/tr/td[2]"));
					for (WebElement w : rwr) {
						if (w.getText()
								.contains(ConfigManager.getconfigManager().getInstanceConfigReader().doctorKpid())) {
							w.click();
							break;
	...
	private void Settings() throws InterruptedException, IOException {
		...
		WebElement rr = driver.findElement(By.xpath("(//input[@placeholder='Select or Enter Specialty'])[1]"));
		sleep(2000);
		actions("click", rr);
		sleep(2000);
		rr.sendKeys("abdominal surgery");
		sleep(3000);
		WebElement splm = driver.findElement(By.xpath("//span[text()='Abdominal Surgery']"));
		actions("click", splm);
		driver.findElement(By.xpath("(//button[@id='save-btn'])[7]")).click();
		sleep(3000);
		WebElement splrem = driver.findElement(By.xpath("//div[text()='Abdominal Surgery']"));
		actions("click", splrem);
		sleep(3000);
		WebElement spldel = driver.findElement(By.xpath("(//img[@id='del-btn'])[1]"));
		...
		sleep(3000);
		List<WebElement> setfav = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav) {
			if (w.getText().trim().equals("Symptoms")) {
				w.click();
				break;
			}
		...
		implicitWait(30, TimeUnit.SECONDS);
		sleep(3000);
		driver.findElement(By.xpath("(//div[@id='symptom'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"))
				.click();
		sleep(3000);
		driver.findElement(By.xpath("(//div[text()='ICD-10-CM R'])[2]//following::div[1]/div/textarea"))
		...
		sleep(3000);
		WebElement ff = driver.findElement(By.xpath("(//div[text()='R10.81: Abdominal tenderness'])[1]"));
		actions("click", ff);
		sleep(2000);
		driver.findElement(By.xpath("(//span[@id='del-btn'])[4]")).click();
		sleep(4000);
		WebElement back = driver.findElement(By.xpath("(//span[@id='assign-cancel-btn'])[1]"));
		j.executeScript("arguments[0].click();", back);
		sleep(4000);
		implicitWait(30, TimeUnit.SECONDS);
		...
		WebElement problemadd = driver.findElement(By.xpath("(//span[@id='plus-add'])[3]"));
		j.executeScript("arguments[0].click();", problemadd);
		sleep(2000);
		...
		sleep(2000);
		driver.findElement(By.xpath("(//div[text()='Notes'])[2]//following::div[1]/textarea")).sendKeys("high");
		sleep(2000);
		WebElement saveproblem = driver.findElement(By.xpath("(//div[@id='save-btn'])[2]"));
		saveproblem.click();
		sleep(2000);
		...
		sleep(3000);
		WebElement delprob = driver.findElement(By.xpath("(//span[@id='del-btn'])[6]"));
		j.executeScript("arguments[0].click();", delprob);

		WebElement cancelfavprob = driver
				.findElement(By.xpath("(//span[contains(text(),'Favorite Problems')])[1]//parent::div/span[1]"));
		...
		driver.findElement(By.xpath("//button[@onclick='setfavdropdown();']")).click();
		sleep(3000);
		List<WebElement> setfav2 = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav2) {
			if (w.getText().trim().equals("Medications")) {
				w.click();
				break;
			}

		}
		WebElement clickaddmed = driver
				.findElement(By.xpath("(//div[@id='drug'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"));
		javascriptclick(clickaddmed);
		sleep(2000);
		WebElement addmeddis = driver
				.findElement(By.xpath("(//div[text()='Medication*'])[2]//following::div[1]/div[1]/input"));
		addmeddis.sendKeys("test");
		sleep(3000);
		List<WebElement> meddrop = driver
				.findElements(By.xpath("(//div[@id='drug'])/div[3]/div/div/div[2]/ul/li/a/div/small/em"));
		System.out.println("size of med drp:" + meddrop.size());
		for (WebElement we : meddrop) {
			if (we.getText().trim().equals("RXNORM = 1190953")) {
				we.click();
				break;
			}
		...
		sleep(4000);
		WebElement deletemed = driver.findElement(By.xpath("(//span[@id='del-btn'])[8]"));
		j.executeScript("arguments[0].click();", deletemed);
		sleep(3000);
		WebElement backmed = driver
				.findElement(By.xpath("(//span[text()='Favorite Medications'])[1]//parent::div/span[1]"));
		j.executeScript("arguments[0].click();", backmed);
		sleep(5000);
		...
		driver.findElement(By.xpath("//button[@onclick='setfavdropdown();']")).click();
		sleep(3000);
		List<WebElement> setfav3 = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav3) {
			if (w.getText().trim().equals("Test Order")) {
				w.click();
				break;
			}
		...
		sleep(2000);
		WebElement clicktestorder = driver
				.findElement(By.xpath("(//div[@id='test-order'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"));
		actions("click", clicktestorder);
		sleep(2000);
		driver.findElement(
				By.xpath("(//div[text()='LOINC / TEST CODE / DESCRIPTION*'])[2]//following::div[1]/div/textarea"))
				.sendKeys("test");
		sleep(3000);
		List<WebElement> testdrop = driver
				.findElements(By.xpath("(//div[@id='test-order'])[1]/div[3]/div/div/div[2]/ul/li/a/div/span/em"));
		for (WebElement web : testdrop) {
			if (web.getText().trim().equals("LOINC-NUM :5802-4")) {
				web.click();
				break;
			}
		...
		WebElement savetestorder = driver.findElement(By.xpath("(//div[@id='save-btn'])[6]"));
		j.executeScript("arguments[0].click();", savetestorder);
		sleep(4000);
		WebElement editest = driver
				.findElement(By.xpath("(//span[text()='Nitrite [Presence] in Urine by Test strip'])[1]"));
		actions("click", editest);
		sleep(4000);
		WebElement deltetest = driver.findElement(By.xpath("(//span[@id='del-btn'])[10]"));
		j.executeScript("arguments[0].click();", deltetest);
		WebElement canceltest = driver
				.findElement(By.xpath("(//span[text()='Favorite Test Order'])[1]//parent::div/span[1]"));

		ww.until(ExpectedConditions.elementToBeClickable(canceltest));
		j.executeScript("arguments[0].click();", canceltest);
		sleep(5000);

		// Item/services
		driver.findElement(By.xpath("//button[@onclick='setfavdropdown();']")).click();
		sleep(3000);
		List<WebElement> setfav4 = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav4) {
		...
		WebElement clickadditem = driver
				.findElement(By.xpath("(//div[@id='invoiceAdd'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"));
		j.executeScript("arguments[0].click();", clickadditem);
		driver.findElement(By.xpath("(//label[text()='Item/Service*'])[2]//following::div[1]/div/input"))
				.sendKeys("test");
		driver.findElement(By.xpath("(//label[text()='Price*'])[2]//following::div[1]/input")).sendKeys("5");
		WebElement saveitem = driver.findElement(By.xpath("(//button[@id='save-btn'])[14]"));
		sleep(4000);
		j.executeScript("arguments[0].click();", saveitem);
		sleep(4000);
		WebElement edititem = driver.findElement(By.xpath("//span[text()='test']"));
		actions("click", edititem);
		WebElement deleteitem = driver.findElement(By.xpath("(//span[@id='del-btn'])[12]"));
		j.executeScript("arguments[0].click();", deleteitem);
		WebElement itemservicebackarrow = driver
				.findElement(By.xpath("(//span[contains(text(),'Favorite Item/Service')])[2]//parent::div/span[1]"));
		j.executeScript("arguments[0].click();", itemservicebackarrow);
		WebElement aaa = driver.findElement(By.xpath("(//span[@id='assign-cancel-btn'])[5]"));
		javascriptclick(aaa);
		sleep(3000);
		...
		driver.findElement(By.xpath("//button[@onclick='setfavdropdown();']")).click();
		sleep(3000);
		List<WebElement> setfav5 = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav5) {
			if (w.getText().trim().equals("Message")) {
				w.click();
				break;
			}
		...
		WebElement addnewfavmessage = driver
				.findElement(By.xpath("(//div[@id='message'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"));
		j.executeScript("arguments[0].click();", addnewfavmessage);
		sleep(2000);
		driver.findElement(By.xpath(
				"(//div[contains(text(),'Add your favorite message and use them quickly')])[2]//following::div[2]/textarea"))
				.sendKeys("hello");
		WebElement savemesssage = driver.findElement(By.xpath("(//div[@id='save-btn'])[8]"));
		j.executeScript("arguments[0].click();", savemesssage);
		sleep(4000);
		WebElement editmessage = driver.findElement(By.xpath("//div[text()='hello']"));
		actions("click", editmessage);
		WebElement deletemessage = driver.findElement(By.xpath("(//span[@id='del-btn'])[14]"));
		j.executeScript("arguments[0].click();", deletemessage);
		sleep(3000);
		WebElement gobackmessage = driver
				.findElement(By.xpath("(//span[text()='Favorite Message'])[1]//parent::div/span[1]"));
		j.executeScript("arguments[0].click();", gobackmessage);
		sleep(3000);
		...
		driver.findElement(By.xpath("//button[@onclick='setfavdropdown();']")).click();
		sleep(3000);
		List<WebElement> setfav6 = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav6) {
			if (w.getText().trim().equals("Advance Directives")) {
				w.click();
				break;
			}
		...
		WebElement addadvfav = driver
				.findElement(By.xpath("(//div[@id='directives'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"));
		j.executeScript("arguments[0].click();", addadvfav);
		sleep(3000);
		WebElement selectadvdir = driver
				.findElement(By.xpath("(//select[contains(@title,'Select Directive type')])[2]"));
		selectadvdir.click();
		sleep(3000);

		dropDown("text", selectadvdir, "Assessment");
		driver.findElement(By.xpath("//textarea[contains(@title,'Enter favorite Assessment details')]"))
				.sendKeys("test");
		WebElement saveaddvancedir = driver.findElement(By.xpath("(//div[@id='save-btn'])[10]"));
		js.executeScript("arguments[0].click();", saveaddvancedir);
		sleep(3000);
		WebElement editadv = driver.findElement(By.xpath("//span[text()='Assessment']"));
		actions("click", editadv);
		WebElement deladv = driver.findElement(By.xpath("(//span[@id='del-btn'])[16]"));
		...
		j.executeScript("arguments[0].click();", gobackadvfav);
		sleep(3000);
		...
		driver.findElement(By.xpath("//button[@onclick='setfavdropdown();']")).click();
		sleep(3000);
		List<WebElement> setfav7 = driver.findElements(By.xpath("//ul[@id='setfavoritesul']/li"));
		for (WebElement w : setfav7) {
			if (w.getText().trim().equals("Status")) {
				w.click();
				break;
			}
		...
		WebElement addstatus = driver.findElement(
				By.xpath("(//div[@id='status-module'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[2]"));
		j.executeScript("arguments[0].click();", addstatus);
		sleep(2000);
		WebElement selectstatus = driver.findElement(By.xpath("(//select[contains(@title,'Select Status type')])[2]"));
		dropDown("text", selectstatus, "Functional status");
		sleep(2000);
		driver.findElement(By.xpath("(//select[contains(@title,'Select Status type')])[2]//following::div[4]/textarea"))
				.sendKeys("hello");

		WebElement clickdatebox = driver
		...
		sleep(3000);
		WebElement editstatus = driver.findElement(By.xpath("//div[text()='Functional Status']"));
		actions("click", editstatus);
		WebElement delstatus = driver.findElement(By.xpath("(//span[@id='del-btn'])[18]"));
		j.executeScript("arguments[0].click();", delstatus);
		sleep(3000);
		WebElement backtofav = driver
				.findElement(By.xpath("(//span[contains(text(),'Favorite Status')])[1]//parent::div/span[1]"));
		j.executeScript("arguments[0].click();", backtofav);
		sleep(3000);
		...
		sleep(3000);
		WebElement itemcodeadd = driver
				.findElement(By.xpath("(//div[@id='item-code'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[3]"));
		javascriptclick(itemcodeadd);
		sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Item/Service Code*'])[2]//following::div[1]/input"))
				.sendKeys("160899");
		driver.findElement(
				By.xpath("(//label[text()='Item/Service Name/Description*'])[2]//following::div[1]/textarea"))
				.sendKeys("Birthday");
		driver.findElement(By.xpath("(//input[contains(@title,'Enter price value for the Item/Service')])[2]"))
				.sendKeys("5");

		sleep(2000);
		WebElement hg = driver.findElement(By.xpath("(//button[@id='save-btn'])[16]"));
		js.executeScript("arguments[0].click();", hg);
		sleep(3000);
		WebElement cc = driver.findElement(By.xpath("//div[text()='160899']"));
		actions("click", cc);
		sleep(3000);
		WebElement vv = driver.findElement(By.xpath("(//span[@id='del-btn'])[20]"));
		js.executeScript("arguments[0].click();", vv);
		WebElement th = driver
				.findElement(By.xpath("(//span[contains(text(),'Item/Service Code')])[1]//parent::div/span[1]"));
		js.executeScript("arguments[0].click();", th);
		sleep(3000);

		// procedure code...

		driver.findElement(By.xpath("//button[@onclick='hospitalcodedropdown();']")).click();
		List<WebElement> fh22 = driver.findElements(By.xpath("//ul[@id='hospitalcodeul']/li"));
		for (WebElement w : fh22) {
		...
		sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Procedure Code*'])[2]//following::div[1]/input"))
				.sendKeys("Procedure12");
		driver.findElement(By.xpath("(//label[text()='Procedure Name/Description*'])[2]//following::div[1]/textarea"))
				.sendKeys("medicine");
		driver.findElement(By.xpath("(//input[contains(@title,'Enter amount value for the procedure')])[2]"))
				.sendKeys("2");
		WebElement saveprocedure = driver.findElement(By.xpath("(//button[@id='save-btn'])[18]"));
		j.executeScript("arguments[0].click();", saveprocedure);
		sleep(3000);
		WebElement editprocedure = driver.findElement(By.xpath("//div[text()='PROCEDURE12']"));
		actions("click", editprocedure);
		WebElement delprocd = driver.findElement(By.xpath("(//span[@id='del-btn'])[22]"));
		j.executeScript("arguments[0].click();", delprocd);
		WebElement gobackproced = driver
				.findElement(By.xpath("(//span[text()='Procedure Code'])[3]//parent::div/span[1]"));
		j.executeScript("arguments[0].click();", gobackproced);

		// Medication code..

		driver.findElement(By.xpath("//button[@onclick='hospitalcodedropdown();']")).click();
		List<WebElement> fh22t = driver.findElements(By.xpath("//ul[@id='hospitalcodeul']/li"));
		for (WebElement w : fh22t) {
		...
		WebElement clickaddmedd = driver
				.findElement(By.xpath("(//div[@id='drug-code'])[1]/div[2]/div[1]/div/table/tbody/tr/td[4]/span[3]"));
		j.executeScript("arguments[0].click();", clickaddmedd);
		sleep(3000);
		driver.findElement(By.xpath("(//label[text()='Medication Code*'])[2]//following::div[1]/input"))
				.sendKeys("MED1");
		driver.findElement(By.xpath("(//input[contains(@title,'Enter name of the Medication')])[2]"))
				.sendKeys("medication med");
		driver.findElement(By.xpath("(//label[text()='Strength'])[4]//following::div[1]/input")).sendKeys("powerful");
		driver.findElement(By.xpath("(//label[text()='Company'])[2]//following::div[1]/input")).sendKeys("kaaspro");
		driver.findElement(By.xpath("(//input[contains(@title,'Enter amount value for the Medication')])[2]"))
				.sendKeys("3");
		...
		j.executeScript("arguments[0].click();", savemedication);
		sleep(3000);
		WebElement editmedication = driver.findElement(By.xpath("(//div[@id='drug-code-text'])[2]"));
		...
		List<WebElement> numberofformspresent = driver
				.findElements(By.xpath("(//div[@class='form-pop-body'])[3]/div/div[1]"));
		int ffs = numberofformspresent.size();
		System.out.println(ffs);
		...
		for (int imp = 4; imp <= ffs; imp++) {
			...
			WebElement rtt = driver
					.findElement(By.xpath("(//div[@class='form-pop-body'])[3]/div[" + imp + "]/div/div[1]/span[2]"));
